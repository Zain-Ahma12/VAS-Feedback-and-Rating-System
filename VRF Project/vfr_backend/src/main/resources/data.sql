...
-- VALUES 
--   ('ahmad_zain', 'ahmad.zain@example.com', 'Password123', 'NORMALUSER', CURRENT_TIMESTAMP),
--   ('john_doe', 'john.doe@example.com', 'Secret1234', 'NORMALUSER', CURRENT_TIMESTAMP),
--   ('jane_smith', 'jane.smith@example.com', 'StrongPass1', 'ADMIN', CURRENT_TIMESTAMP),
--   ('maria_raj', 'maria.raj@example.com', 'SecurePwd9', 'NORMALUSER', CURRENT_TIMESTAMP),
--   ('rahul_k', 'rahul.kumar@example.com', 'MyPass2025', 'NORMALUSER', CURRENT_TIMESTAMP),
--   ('emily_w', 'emily.wilson@example.com', 'SafePass88', 'NORMALUSER', CURRENT_TIMESTAMP),
--   ('david_b', 'david.brown@example.com', 'Qwerty2024', 'ADMIN', CURRENT_TIMESTAMP),
--   ('sophia_m', 'sophia.miller@example.com', 'PassWord77', 'NORMALUSER', CURRENT_TIMESTAMP),
--   ('li_chen', 'li.chen@example.com', 'ChinaPass88', 'NORMALUSER', CURRENT_TIMESTAMP),
--   ('mohammed_h', 'mohammed.hassan@example.com', 'Strong9999', 'NORMALUSER', CURRENT_TIMESTAMP);
...
-- INSERT INTO Feedback (rating, comment, feedback_time, user_id, vas_pack_id) VALUES
